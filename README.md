...
**例：**
```
📖 タイトルID を入力してください（例: 299367）: 299367
...
```bash
# 最初の5ページをダウンロード
node binb_scraper.js 'https://www.cmoa.jp/reader/sample/?title_id=299367&content_id=100002993670001' 5

# 全ページをダウンロード
node binb_scraper.js 'https://www.cmoa.jp/reader/sample/?title_id=299367&content_id=100002993670001'
...
例: タイトルID 299367、第1巻
→ 1000 + 0299367 + 0001 = 100002993670001
```
